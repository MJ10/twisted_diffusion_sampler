...
class Experiment:
    ...
    def eval_fn(self, eval_dir, valid_loader, device, min_t=None, num_t=None, noise_scale=1.0):
        ...
        for valid_feats, pdb_names in valid_loader:
            ...
            rigids_t = Rigid.from_tensor_7(valid_feats['rigids_t'])
    ...
    def inference_fn(
        ...
        if 'rigids_motif' in sample_feats:
            all_bb_prots_uncond = []
        ...
        if 'rigids_motif' in sample_feats and aux_traj:
            all_trans_0_pred_uncond = flip(all_trans_0_pred_uncond)
            all_bb_0_pred_uncond = flip(all_bb_0_pred_uncond)
        ...
        if 'rigids_motif' in sample_feats and aux_traj:
            ret['trans_traj_uncond'] = all_trans_0_pred_uncond
            ret['rigid_0_traj_uncond'] = all_bb_0_pred_uncond
        return ret
